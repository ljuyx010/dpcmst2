...
<head>
    ...
    <link rel="stylesheet" href="{:ROOT}public/static/jump/msgbox.css" />
    <link rel="stylesheet" href="{:ROOT}public/static/jump/sweetalert.css" />
    ...
    <div class="system-message">
      <!-- 成功提示 -->
        <?php switch ($code) {?>
            ...
            </div><div class="sa-icon sa-custom" style="display: none; width: 80px; height: 80px; background-image: url({:ROOT}public/static/jump/thumbs-up.jpg);"></div><h2><?php echo(strip_tags($msg));?></h2>
            <p style="display: block;">正在跳转，等待时间： <b id="wait"><?php echo($wait);?></b></p>
            <fieldset>
